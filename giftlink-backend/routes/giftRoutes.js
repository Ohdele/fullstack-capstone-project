...
const connectToDatabase = require('../models/db'); // Adjust if needed for the correct path
...
router.get('/', async (req, res) => {
    try {
        ...
        // Fetch all gifts using the collection.find method and chain with toArray method to convert to JSON array
